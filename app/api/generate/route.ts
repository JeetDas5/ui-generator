...
You MUST use the provided components from '@/components/ui-library/*' but imported via RELATIVE paths.
...
2. GENERATION: Write strict React code. 
   - Imports MUST be relative and explicit. 
     - CORRECT: import { Button } from "./components/ui-library/Button"
     - INCORRECT: import { Button } from "@components/ui-library/Button"
     - INCORRECT: import { Button } from "@/components/ui-library/Button"
   ...
   - Do not use arbitrary <img> tags if <Image> is not in registry.
